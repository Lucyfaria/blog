...
class FractionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fraction" do
    assert_difference("Fraction.count") do
      post fractions_url, params: { fraction: { contract: @fraction.contract, lights: @fraction.lights, name: @fraction.name, pearl: @fraction.pearl, plate: @fraction.plate, primary: @fraction.primary, secondary: @fraction.secondary, smoke: @fraction.smoke } }
    end
  ...
  test "should update fraction" do
    patch fraction_url(@fraction), params: { fraction: { contract: @fraction.contract, lights: @fraction.lights, name: @fraction.name, pearl: @fraction.pearl, plate: @fraction.plate, primary: @fraction.primary, secondary: @fraction.secondary, smoke: @fraction.smoke } }
